<template>
  <div>
    ...
    <div class="container pb-50">
      ...
      <el-form class="mt-100 tc phone-input bc" ref="form" :model="searchData" label-width="100px">
        <el-form-item label="手机号">
          <el-input id="input" v-model="searchData.phone"></el-input>
        </el-form-item>
        <el-form-item label="密码">
          <el-input id="password" type="password" v-model="searchData.password"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    onSubmit() {
      ...
      }else if(!this.searchData.password){
        this.$message.error("请输入密码")
        document.querySelector("#password").focus()
      }else{
        this.$router.push({path:'/info',query:{phoneNumber:this.searchData.phone}});
